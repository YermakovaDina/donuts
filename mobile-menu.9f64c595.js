...
(function () {
  ...
  var menuBtn2Ref = document.querySelector('[data-menu-button2]');
  var menuBtn3Ref = document.querySelector('[data-item]');
  var menuBtn4Ref = document.querySelector('[data-item2]');
  var menuBtn5Ref = document.querySelector('[data-item3]');
  var menuBtn6Ref = document.querySelector('[data-item4]');
  ...
  function menu() {
    var expanded = menuBtn2Ref.getAttribute('aria-expanded') === 'true' || false;
